...
const ItemPreview = props => {
  ...
  const itemImage  = isUrl(item.image) ? item.image : defaultImage;
  const  sellerImage = isUrl(item.seller.image) ? item.seller.image : defaultImage;
  return (
    <div className="card">
      <img src={itemImage} className="card-img-top item-img" />
